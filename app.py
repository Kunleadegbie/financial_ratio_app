...
st.title("📊 Financial Ratio & Cash Flow Calculator (General + Banking Ratios)")
st.markdown("Calculate financial and banking ratios based on your input figures.")

# Company Name
company = st.text_input("Company Name", "")

st.header("📑 General Financial Data Inputs")
...
# 📌 Banking/Financial Institution Specific Inputs
st.header("🏦 Banking-Specific Financial Data")
...
high_quality_liquid_assets = st.number_input("High-Quality Liquid Assets (HQLA)", min_value=0.0, value=0.0)
net_cash_outflows_30d = st.number_input("Total Net Cash Outflows over 30 days", min_value=0.0, value=0.0)
